<template>
  <ion-page>
    ...
    <ion-content>
      ...
      <div class="container-lg max-sm:!mt-6" :class="{
        ...
        <div class="row" :class="{
          ...
          <div
            class="row align-items-center gy-5 max-sm:!px-2" :class="{
            ...
            >
              <div :id="`card-${item.id}`" class="card !h-44 sm:!h-64">
                ...
                >
                  ...
                  <div class="absolute bottom-0 left-0 w-full px-2 pt-2 bg-[--bs-card-bg]">
          ...
          <div v-if="outfitSelectionMode" class="col-3 bg-white dark:!bg-zinc-800 flex items-center flex-col">
            ...
            <div>
              <div
                ...
                :id="`outfit-card-${item.id}`"
                :key="item.id"
                class="card !h-44 sm:!h-48"
              >
                <div
                  class="card-body cursor-pointer justify-between flex flex-col max-sm:!px-2 overflow-y-clip max-h-full"
                  @click="() => showModal(item)"
                >
                  <button
                    type="button" class="btn-close absolute right-1 top-1"
                    aria-label="Remove clothing item"
                    @click="() => removeFromCheckedItems(item.id)"
                  />
